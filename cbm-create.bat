...
echo -- ----------------------------------------------
@powershell -command "copy-item -Path 'S:\TEST AREA\ac00418\CBM\rev_i\cbm-create.ps1' -destination cbm-create.ps1"
...
@powershell -command "Remove-Item cbm-create.ps1"
pause
